...
def build_practical_suggestions_query(constitutional_topic: str) -> str:
    """
    Convert a constitutional topic into a practical web search query.
    
    Examples:
    - "Article 21 right to life" → "how to file criminal complaint India procedure"
    ...
    query_mappings = {
        "right to life": "how to file criminal complaint FIR India procedure",
        "personal liberty": "illegal detention habeas corpus India how to file",
        "freedom of speech": "freedom of speech expression India legal rights how to exercise",
        "right to education": "Right to Education Act India how to complain school admission",
        ...
        "life liberty": "police complaint procedure India online FIR filing",
        "fundamental rights": "violation of fundamental rights India where to complain",
    }
    ...
    # Default: generate a generic practical query
    return f"{constitutional_topic} India legal procedure how to file complaint application"
